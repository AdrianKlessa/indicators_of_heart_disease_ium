...
if 'training_parameters' not in os.environ:
    print("Unable to find training parameters in environment variables")
    parameter_epochs = 11
...
# Set up early stopping for model regularization (counter overfitting)
...
print(f"Preditction accuracy on the validation dataset: {validation_accuracy:.2%}")
print("Example predictions (raw floats):")
print(predictions[:100])
print("Example predictions (rounded):")
